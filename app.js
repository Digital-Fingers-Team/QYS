...
const translations = {
    ar: {
        ...
        ai_assistant_title: "مساعدك الرياضي الذكي",
        ai_assistant_desc: "نستخدم تقنيات تحليل البيانات لنقدم لك أفضل التوصيات الرياضية التي تناسب اهتماماتك وفئتك العمرية لتحقيق أقصى استفادة.",
        age_category: "الفئة العمرية",
        choose_category: "اختر الفئة",
        under_12: "أقل من 12 سنة",
        teens: "12 - 18 سنة",
        youth_20s: "19 - 30 سنة",
        adults_30s: "31 - 45 سنة",
        seniors: "أكثر من 45 سنة",
        main_goal: "الهدف الأساسي",
        choose_goal: "اختر هدفك",
        build_muscles: "بناء العضلات",
        lose_weight: "خسارة الوزن",
        general_fitness: "لياقة عامة",
        social_activity: "نشاط اجتماعي",
        get_recommendations: "الحصول على التوصيات",
        smart_analyzer: "المحلل الذكي",
        analyzing: "جاري التحليل...",
        recommendation_result: "نتيجة التوصية",
        ai_recommendation: "توصية الذكاء الاصطناعي",
        about_sport: "عن الرياضة",
        benefits: "الفوائد",
        start_now: "ابدأ الآن",
        no_selection: "يرجى اختيار الفئة العمرية والهدف",
        points_needed: "نقاط مطلوبة",
        my_points_label: "نقاطي:",
        edit_profile_btn: "تعديل الملف",
        qalyubia_egypt: "القليوبية، مصر",
    ...
    en: {
        ...
        // Profile & AI Recommendations
        ai_assistant_title: "Your Smart Sports Assistant",
        ai_assistant_desc: "We use data analysis techniques to provide you with the best sports recommendations that suit your interests and age group for maximum benefit.",
        age_category: "Age Category",
        choose_category: "Choose Category",
        under_12: "Under 12 years",
        teens: "12 - 18 years",
        youth_20s: "19 - 30 years",
        adults_30s: "31 - 45 years",
        seniors: "Over 45 years",
        main_goal: "Main Goal",
        ...
        about_sport: "About the Sport",
        benefits: "Benefits",
        start_now: "Start Now",
        no_selection: "Please select age category and goal",
        points_needed: "Points Needed",
        my_points_label: "My Points:",
        edit_profile_btn: "Edit Profile",
        qalyubia_egypt: "Qalyubia, Egypt",
